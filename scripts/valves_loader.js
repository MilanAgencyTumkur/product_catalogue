...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (productId) {
    fetch("../../data/valves.json")
      ...
      .then((valves) => {
        const product = valves.find((item) => item.id === productId);
        if (product) {
          displayValveProduct(product);
        } else {
...
function displayValveProduct(product) {
  ...
  productContainer.innerHTML = `
    ...
    <div class="product-container">
      ...
      <div class="product-details-content">
        ...
        <!-- Benefits -->
        <div class="info-section">
          <h3 class="section-title"><i class="fas fa-star icon"></i>Benefits</h3>
          <ul class="info-list">
